...
## Summary
This project showcases how the Analog-to-Digital Converter with Computation (ADCC) on the new PIC18-Q43 can be used to read an analog value from a pin while removing high-frequency noise form the measurement.